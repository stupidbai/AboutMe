...
originalSource: "https://github.com/arch3rPro/arch3rpro.github.io/blob/acf58fa03821905916b0fc605ec893eadf6063fe/posts/blog/2025/vitepress-style/README.md"
sourceCommit: "acf58fa03821905916b0fc605ec893eadf6063fe"
isReference: false
outline: deep
---
> 历史知识归档：由白云飞以 arch3rPro 账号首次发布，本次经本人授权迁移。原始发布日期：2025-03-29 20:34:56。
...
效果：
`外部图片`（外部图片地址已留档）（`https://shields.io/badges`）
...
<p>
`Spring`（外部图片地址已记录在本地迁移清单中）
`Spring Boot`（外部图片地址已记录在本地迁移清单中）
`MySQL`（外部图片地址已记录在本地迁移清单中）
`MariaDB`（外部图片地址已记录在本地迁移清单中）
`PostgreSQL`（外部图片地址已记录在本地迁移清单中）
`Oracle`（外部图片地址已记录在本地迁移清单中）
`Microsoft SQL Server`（外部图片地址已记录在本地迁移清单中）
`Redis`（外部图片地址已记录在本地迁移清单中）
`MongoDB`（外部图片地址已记录在本地迁移清单中）
`RabbitMQ`（外部图片地址已记录在本地迁移清单中）
`Solr`（外部图片地址已记录在本地迁移清单中）
`ElasticSearch`（外部图片地址已记录在本地迁移清单中）
`Logstash`（外部图片地址已记录在本地迁移清单中）
`Kibana`（外部图片地址已记录在本地迁移清单中）
`Kafka`（外部图片地址已记录在本地迁移清单中）
`Consul`（外部图片地址已记录在本地迁移清单中）
`Tomcat`（外部图片地址已记录在本地迁移清单中）
`JUnit5`（外部图片地址已记录在本地迁移清单中）
`Liquibase`（外部图片地址已记录在本地迁移清单中）
`Maven`（外部图片地址已记录在本地迁移清单中）
`Gradle`（外部图片地址已记录在本地迁移清单中）
`Spring Security`（外部图片地址已记录在本地迁移清单中）
`Hibernate`（外部图片地址已记录在本地迁移清单中）
`JSON`（外部图片地址已记录在本地迁移清单中）
`JWT`（外部图片地址已记录在本地迁移清单中）
`Java`（外部图片地址已记录在本地迁移清单中）
`Python`（外部图片地址已记录在本地迁移清单中）
`Android`（外部图片地址已记录在本地迁移清单中）
`Go`（外部图片地址已记录在本地迁移清单中）
`GraphQL`（外部图片地址已记录在本地迁移清单中）
</p>

#### 前端技术栈

<p>
`Vue3`（外部图片地址已记录在本地迁移清单中）
`TypeScript`（外部图片地址已记录在本地迁移清单中）
`Ant Design`（外部图片地址已记录在本地迁移清单中）
`Node.js`（外部图片地址已记录在本地迁移清单中）
`Vite`（外部图片地址已记录在本地迁移清单中）
`Webpack`（外部图片地址已记录在本地迁移清单中）
`NPM`（外部图片地址已记录在本地迁移清单中）
`Axios`（外部图片地址已记录在本地迁移清单中）
`ESLint`（外部图片地址已记录在本地迁移清单中）
`jQuery`（外部图片地址已记录在本地迁移清单中）
`BootStrap`（外部图片地址已记录在本地迁移清单中）
`ECharts`（外部图片地址已记录在本地迁移清单中）
`JavaScript`（外部图片地址已记录在本地迁移清单中）
`HTML5`（外部图片地址已记录在本地迁移清单中）
`CSS3`（外部图片地址已记录在本地迁移清单中）
`Tailwind CSS`（外部图片地址已记录在本地迁移清单中）
`Less`（外部图片地址已记录在本地迁移清单中）
</p>

#### DevOps

<p>
`Git`（外部图片地址已记录在本地迁移清单中）
`GitHub`（外部图片地址已记录在本地迁移清单中）
`Gitee`（外部图片地址已记录在本地迁移清单中）
`gitlab`（外部图片地址已记录在本地迁移清单中）
`GitHub Actions`（外部图片地址已记录在本地迁移清单中）
`Jenkins`（外部图片地址已记录在本地迁移清单中）
`SonarQube`（外部图片地址已记录在本地迁移清单中）
`Docker`（外部图片地址已记录在本地迁移清单中）
`Harbor`（外部图片地址已记录在本地迁移清单中）
`Kubernetes`（外部图片地址已记录在本地迁移清单中）
`CentOS`（外部图片地址已记录在本地迁移清单中）
`Ubuntu`（外部图片地址已记录在本地迁移清单中）
</p>

#### 运维技术栈

<p>
`阿里云`（外部图片地址已记录在本地迁移清单中）
`Nginx`（外部图片地址已记录在本地迁移清单中）
`VMware`（外部图片地址已记录在本地迁移清单中）
`Prometheus`（外部图片地址已记录在本地迁移清单中）
`Grafana`（外部图片地址已记录在本地迁移清单中）
`Ansible`（外部图片地址已记录在本地迁移清单中）
`Lua`（外部图片地址已记录在本地迁移清单中）
</p>

#### 测试技术栈

<p>
`Postman`（外部图片地址已记录在本地迁移清单中）
`JMeter`（外部图片地址已记录在本地迁移清单中）
</p>

#### 开发工具

<p>
`Intellij IDEA`（外部图片地址已记录在本地迁移清单中）
`Eclipse`（外部图片地址已记录在本地迁移清单中）
`WebStorm`（外部图片地址已记录在本地迁移清单中）
`PyCharm`（外部图片地址已记录在本地迁移清单中）
`Android Studio`（外部图片地址已记录在本地迁移清单中）
`VSCode`（外部图片地址已记录在本地迁移清单中）
</p>

#### 其他

<p>
`Markdown`（外部图片地址已记录在本地迁移清单中）
`WordPress`（外部图片地址已记录在本地迁移清单中）
`GitHub Pages`（外部图片地址已记录在本地迁移清单中）
`Adobe Photoshop`（外部图片地址已记录在本地迁移清单中）
</p>
...
本地迁移记录：`posts/blog/2025/vitepress-style/README.md` · 源提交：`acf58fa03821` · [查看本地迁移说明](/knowledge#内容与来源边界)
